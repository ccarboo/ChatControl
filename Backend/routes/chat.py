...
# ==============================================================================
# Helpers for processing and extracting decrypted data for messages history
# ==============================================================================

async def _get_system_message(msg: MessageService, client) -> str:
    """Trasforma un aggiornamento di sistema in stringa leggibile."""
    action = msg.action
...
def _calculate_time_window(messages: list) -> tuple[datetime | None, datetime | None]:
    """Calcola la 'finestra' temporale inclusiva per scaricare payload asincroni e mitigare gap."""
